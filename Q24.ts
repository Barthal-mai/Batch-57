...
console.log("equality testing:", ("barthalmai" as string)==="barthalmai");
console.log("Inequality testing:", ("barthalmai" as string)==="Bm Judah");
...
console.log("inequality:",(10 as number)!==9)
...
const car = [1, 2, 3, 4, 5]; // An array named 'car' with elements 1, 2, 3, 4, 5
